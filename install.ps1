...
try {
    ...
    # Spusť VS Code Insiders se složkou C:\Proj_Net\portal-ui a povoleným API návrhem
    Write-Host "   - Starting VS Code Insiders with portal-ui and enabled API proposals..." -ForegroundColor Gray
    Start-Process -FilePath 'code-insiders' -ArgumentList '--enable-proposed-api','sunamocz.ai-prompt-detector','C:\Proj_Net\portal-ui' -WindowStyle Hidden
