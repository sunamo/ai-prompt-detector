...
- **Chronologické Pořadí**: Nejnovější prompt vždy dole (nejstarší nahoře)
...
#1: Refactor UserService class (nejstarší)
#2: Add error handling to API endpoints
#3: Fix the authentication bug in login.ts (nejnovější)
...
```
